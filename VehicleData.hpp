...
struct ThrusterData
{
    static constexpr int COUNT = 1; // 4;
...
struct SystemStatus
{
    OperationModes_t mode =
        OperationModes_t::OP_MODE_STANDBY;
...
struct CommandData
{
    ...
    std::array<float, 4> commandedThruster{};
